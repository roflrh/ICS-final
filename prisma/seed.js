...
async function main() {
  ...
  await prisma.restaurant.create({
    data: {
      ...
      category: '한식',
      subTags: ['고기', '구이', '찌개'],
      imageUrl: 'https://images.unsplash.com/photo-1529193591184-b1d58069ecdd?w=600&auto=format&fit=crop&q=60&v=4',
      rating: 4.8,
      reviewCount: 142,
      deliveryTimeMin: 25,
      deliveryTimeMax: 35,
  ...
  await prisma.restaurant.create({
    data: {
      ...
      category: '치킨',
      subTags: ['닭강정', '튀김', '안주'],
      imageUrl: 'https://images.unsplash.com/photo-1562967914-608f82629710?w=600&auto=format&fit=crop&q=60&v=4',
      rating: 4.8,
      reviewCount: 415,
      deliveryTimeMin: 20,
      deliveryTimeMax: 30,
  ...
  await prisma.restaurant.create({
    data: {
      ...
      subTags: ['곱창', '전골', '안주'],
      hasCoupon: true,
      imageUrl: 'https://images.unsplash.com/photo-1588166524941-3bf61a9c41db?w=600&auto=format&fit=crop&q=60&v=4',
      rating: 4.7,
      reviewCount: 195,
      deliveryTimeMin: 25,
      deliveryTimeMax: 40,
  ...
  await prisma.restaurant.create({
    data: {
      ...
      subTags: ['김치찜', '한식안주', '집밥'],
      hasCoupon: true,
      imageUrl: 'https://images.unsplash.com/photo-1608039829572-78524f79c4c7?w=600&auto=format&fit=crop&q=60&v=4',
      rating: 4.8,
      reviewCount: 280,
      deliveryTimeMin: 25,
      deliveryTimeMax: 35,
