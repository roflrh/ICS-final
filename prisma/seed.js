...
async function main() {
      ...
      menus: {
        create: [
          ...
          },
          {
            ...
            price: 16000,
            imageUrl: 'https://images.unsplash.com/photo-1632733711679-5292d6e3c0b5?w=600&auto=format&fit=crop&q=60&v=5',
          },
          {
            name: '차돌된장찌개',
  ...
  await prisma.restaurant.create({
    data: {
      ...
      category: '일식',
      subTags: ['돈카츠', '튀김', '면'],
      imageUrl: 'https://images.unsplash.com/photo-1598103442097-8b743e43a1c6?w=600&auto=format&fit=crop&q=60&v=5',
      rating: 4.9,
      reviewCount: 210,
      deliveryTimeMin: 20,
      deliveryTimeMax: 30,
      ...
      menus: {
        create: [
          ...
          },
          {
            ...
            price: 10000,
            imageUrl: 'https://images.unsplash.com/photo-1627662236973-4f8259fa2441?w=600&auto=format&fit=crop&q=60&v=5',
          },
        ],
      },
    },
  ...
  await prisma.restaurant.create({
    data: {
      ...
      subTags: ['곱창', '전골', '안주'],
      hasCoupon: true,
      imageUrl: 'https://images.unsplash.com/photo-1547928500-477b23df2a04?w=600&auto=format&fit=crop&q=60&v=5',
      rating: 4.7,
      reviewCount: 195,
      deliveryTimeMin: 25,
      deliveryTimeMax: 40,
  ...
  await prisma.restaurant.create({
    data: {
      ...
      subTags: ['김치찜', '한식안주', '집밥'],
      hasCoupon: true,
      imageUrl: 'https://images.unsplash.com/photo-1601314002592-b8730b2685a5?w=600&auto=format&fit=crop&q=60&v=5',
      rating: 4.8,
      reviewCount: 280,
      deliveryTimeMin: 25,
      deliveryTimeMax: 35,
      ...
      menus: {
        create: [
          ...
          },
          {
            ...
            price: 10000,
            imageUrl: 'https://images.unsplash.com/photo-1551881192-002e02ad3d8b?w=600&auto=format&fit=crop&q=60&v=5',
          },
          {
            name: '부드러운 두부 사리',
  ...
  await prisma.restaurant.create({
    data: {
      ...
      category: '한식',
      subTags: ['국밥', '해장', '수육'],
      imageUrl: 'https://images.unsplash.com/photo-1616169785860-316270de54fb?w=600&auto=format&fit=crop&q=60&v=5',
      rating: 4.8,
      reviewCount: 420,
      deliveryTimeMin: 15,
      deliveryTimeMax: 25,
